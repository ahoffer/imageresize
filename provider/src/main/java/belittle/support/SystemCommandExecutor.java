...
public class SystemCommandExecutor {
   ...
   *
   * <p>List<String> commands = new ArrayList<String>(); commands.add("/sbin/ping");
   ...
   *
   * <p>Note: I've removed the other constructor that was here to support executing the sudo
   * command. I'll add that back in when I get the sudo command working to the point where it won't
   * hang when the given password is wrong.
   *
